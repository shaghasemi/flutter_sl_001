class CategoryMainResponseModel {
  CategoryMainResponseModel({
    List<Data>? data,
    String? message,
    bool? success,
    int? status,
  ...
  CategoryMainResponseModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
...
class CategoryMainRequestModel {
  String token;

  CategoryMainRequestModel({
    required this.token,
  });

  CategoryMainRequestModel.fromJson(Map<String, dynamic> json)
