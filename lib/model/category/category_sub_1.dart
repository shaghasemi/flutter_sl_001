class CategorySubOneResponseModel {
  CategorySubOneResponseModel({
    List<Data>? data,
    String? message,
    bool? success,
    int? status,
  ...
  CategorySubOneResponseModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
...
class CategorySubOneRequestModel {
  String token;
  int status;
  String parentId;

  CategorySubOneRequestModel({
    required this.token,
    required this.status,
    required this.parentId,
  });

  CategorySubOneRequestModel.fromJson(Map<String, dynamic> json)
