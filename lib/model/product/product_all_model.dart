class ProductAllResponseModel {
  ...
  ProductAllResponseModel.fromJson(dynamic json) {
    if (json['data'] != null) {
      _data = [];
      json['data'].forEach((v) {
...
class ProductAllRequestModel {
  String token;

  ProductAllRequestModel({
    required this.token,
  });

  ProductAllRequestModel.fromJson(Map<String, dynamic> json)
